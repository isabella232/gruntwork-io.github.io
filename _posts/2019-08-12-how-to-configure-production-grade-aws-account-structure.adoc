...
Create a `terragrunt.hcl` at the root of your infrastruture-live repo. As you can see, it references `common`, `account`, and `region` hcl files which we'll create shortly.
